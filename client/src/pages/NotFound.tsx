...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-background to-muted">
      <Card className="w-full max-w-lg mx-4 shadow-lg border bg-background/80 backdrop-blur-sm">
        <CardContent className="pt-8 pb-8 text-center">
          ...
          <h1 className="heading-display text-4xl text-foreground mb-2">404</h1>
